...
#define ASSERT_EQ_N_AI(EXPECTED_N_AI, REAL_N_AI) do{ \
...
#define ASSERT_EQ_FRAMES(EXPECTED_FRAME, REAL_FRAME) do{ \
    ...
    ASSERT_EQ_ARRAY((EXPECTED_FRAME).data, (REAL_FRAME).data, (EXPECTED_FRAME).data_length_code); } while(0)
