...
{
public:
    constexpr static const char* TAG = "ISOTP";

    /**
     * This function is used to queue a message to be sent to an N_TA from the current ISOTP object N_SA.
    ...
    /**
     * This function is used to get the N_SA for this ISOTP object.
     * @return The N_SA for this ISOTP object.
     */
    typeof(N_AI::N_SA) getN_SA() const;

    /**
     * This function is used to add a N_TA into the functional accepted N_TAs for this ISOTP object.
     ...
     * @param nTA The N_TA to set for this ISOTP object.
     */
    void addAcceptedFunctionalN_TA(typeof(N_AI::N_TA) nTA);

    /**
     * This function is used to remove a N_TA from the functional accepted N_TAs for this ISOTP object.
     ...
     * @param nTA The N_TA to remove for this ISOTP object.
     * @return True if the N_TA was removed, false otherwise.
     */
    bool removeAcceptedFunctionalN_TA(typeof(N_AI::N_TA) nTA);

    /**
     * This function is used to check if a N_TA is in the functional accepted N_TAs for this ISOTP object.
     * @param nTA The N_TA to check for in this ISOTP object.
    ...
    /**
     * This function is used to get the block size for this ISOTP object.
     * @return The block size for this ISOTP object.
     */
    uint8_t getBlockSize() const;

    /**
     * This function is used to set the block size for this ISOTP object.
     ...
     * @param bs The block size to set for this ISOTP object.
     */
    bool setBlockSize(uint8_t bs);

    /**
     * This function is used to get the separation time for this ISOTP object.
     * @return The separation time for this ISOTP object.
     */
    STmin getSTmin() const;

    /**
     * This function is used to set the separation time for this ISOTP object.
     ...
     * @param stMin The separation time to set for this ISOTP object.
